...
public class PrivateResourceLoader {

	private static final Logger logger = Logger.getLogger(PrivateResourceLoader.class);
	...
	public static InputStream getFileAsStream(String fileName)  {
		...
		InputStream is = PrivateResourceLoader.class.getClassLoader().getResourceAsStream(cleanFileName);
